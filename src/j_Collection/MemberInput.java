...
public class MemberInput extends JInternalFrame {
	...
	public void input() {
		...
		if(mid.getText().equals("") || pwd.getText().equals("")|| mName.getText().equals("") || phone.getText().equals("")) {
			status.setText("입력하신 정보에 공백이 있습니다.");	
		} else {
		this.list.add(vo);
		...
		status.setText("회원 정보가 추가되었습니다." + "(" + list.size() + "건)");
		}
	}
