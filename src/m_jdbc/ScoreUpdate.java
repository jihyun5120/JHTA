...
public class ScoreUpdate extends JInternalFrame {
	 ...
	 */
	public ScoreUpdate() {
		super("학생성적수정", false, true, true, true);
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						if(r>0) {
							...
							status.setText("정보 수정 중 오류가 발생했습니다.");
	...
	private JButton getButton_1() { //조회
		if (button_1 == null) {
	...
	private JLabel getLabel_8() {
		if (label_8 == null) {
			...
			label_8.setBackground(new Color(173, 216, 230));
			label_8.setBounds(0, 10, 313, 35);
		}
		return label_8;
	}
}
